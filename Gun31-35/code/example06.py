...
b64encode / b64decode
-------------------------------------
Serileştirme ve serileştirmeden çıkarma
Serileştirme - nesneyi bayt dizisine (bytes) veya karakter dizisine (str) dönüştürmek
Serileştirmeden çıkarma - bayt veya karakter dizisini yeniden nesneye dönüştürmek
Python standart kütüphanesinin serileştirme desteği:
json - karakter biçiminde serileştirme
pickle - bayt biçiminde serileştirme
dumps / loads
"""
import base64
import json
